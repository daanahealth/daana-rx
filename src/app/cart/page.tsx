                      ...
                      {items.map((item) => (
                        <TableRow key={item.unit.unitId}>
                          <TableCell>
                            <div className="space-y-1">
                              ...
                              <p className="text-xs text-muted-foreground sm:hidden">
                                {item.unit.drug.strength} {item.unit.drug.strengthUnit} &bull;{' '}
                                {item.unit.drug.form}
                              </p>
                            </div>
                          </TableCell>
                          ...
                          <TableCell className="hidden md:table-cell">
                            <Badge
                              variant={
                                new Date(item.unit.expiryDate) < new Date()
                                  ? 'destructive'
                                  : 'secondary'
                              }
                            >
            ...
            <Card className="animate-fade-in">
              <CardContent className="pt-6 space-y-5">
                ...
                <div className="space-y-3">
                  <Label htmlFor="cart-notes" className="text-base font-semibold">
                    Notes (Optional)
                  </Label>
                  <Textarea
                    id="cart-notes"
