...
// StatusChip
// -----------------------------------------------------------------------------
// Canonical status pill per MVP spec § "Status Chips":
//   active           -> green
//   in_cart          -> blue
...
//
// NOTE: This component is also produced by fe-shell-polish. When branches
// merge the orchestrator should keep a single copy. The implementation
// is intentionally identical so a literal de-dup is safe.
...
const STATUS_STYLES: Record<
  ItemStatus,
  { label: string; classes: string; showAlert?: boolean }
> = {
  active: {
    label: 'Active',
