...
import { fail, ok, } from "@daana-health/inventory-core";
 ...
 */
export function tenYearsBeforeToday(today = new Date()) {
 ...
 */
export const requireExpiryForMedications = (item) => {
 ...
 */
export const requireSpecialtyReviewForHighRisk = (item) => {
